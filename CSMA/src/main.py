...
if __name__ == "__main__":
    ...
    chosen = '\n-----------------------------------------------------------------------------\n' \
            ...
            + '\n-----------------------------------------------------------------------------\n\n'
    print(chosen)
    with open('textfiles/report.txt', 'w+', encoding='utf-8') as fptr1: fptr1.write(chosen)
    with open('textfiles/analysis.txt', 'w+', encoding='utf-8') as fptr2: fptr2.write(chosen)
